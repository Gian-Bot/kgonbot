...
await conn.sendHydrated(m.chat, gata, wm, null, md, '𝗞𝗚𝗢𝗡-𝗕𝗢𝗧', null, null, [
['💵 𝘾𝙤𝙢𝙥𝙧𝙖𝙧 𝙓10', '.buy2 10'],
['💸 𝘾𝙤𝙢𝙥𝙧𝙖𝙧 𝙓20', '.buy2 20'],
['⚡ 𝘾𝙤𝙢𝙥𝙧𝙖𝙧 𝙘𝙤𝙣 𝙀𝙭𝙥𝙚𝙧𝙞𝙚𝙣𝙘𝙞𝙖', '/buy']
    ...
    await conn.sendHydrated(m.chat, `*No tiene sufuciente 𝘾𝙊𝙄𝙉𝙎 para comprar ${count} Diamantes* 💎\n\n*Le recomiendo que interactúe con el bot para Obtener GataCoins, puede ver sus Coins con el comando ${usedPrefix}coins o ${usedPrefix}experiencia. También puede comprar con su Experiencia con el Comando ${usedPrefix}buy*`, wm, null, ig, '𝙄𝙣𝙨𝙩𝙖𝙜𝙧𝙖𝙢', null, null, [
['👹 𝘾𝙤𝙢𝙥𝙧𝙖𝙧 𝙘𝙤𝙣 𝙀𝙭𝙥𝙚𝙧𝙞𝙚𝙣𝙘𝙞𝙖', '/buy'],
