...
👹 𝙇𝙊𝘾𝙊, 𝙎𝙄 𝙇𝙊 𝙃𝘼𝘾𝙀𝙎 𝘾𝙊𝙈 𝙈𝘼𝙎 𝘿𝙄𝙁𝙄𝘾𝙐𝙇𝙏𝘼𝘿, 𝙈𝘼𝙔𝙊𝙍 𝙎𝙀𝙍𝘼́ 𝙏𝙐 𝙍𝙀𝘾𝙊𝙈𝙀𝙉𝙎𝘼
`.trim()
...
await conn.sendHydrated(m.chat, `⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️`, `𝙍𝙀𝙎𝙋𝙊𝙉𝘿𝘼 𝘼𝙇 𝙈𝙀𝙉𝙎𝘼𝙅𝙀 𝘿𝙀 𝘼𝙍𝙍𝙄𝘽𝘼 𝘾𝙊𝙉 𝙇𝘼 𝙍𝙀𝙎𝙋𝙐𝙀𝙎𝙏𝘼`, null, md, '𝗞𝗚𝗢𝗡 | 𝗚𝗜𝗔𝗡', null, null, [ 
