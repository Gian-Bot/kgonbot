...
global.reloadHandler = async function (restatConn) {
  ...
  conn.welcome = '*┏ᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔıllıllı\n╏──〘⦓𝙃𝘼𝘽𝙇𝘼 𝙈𝘼𝙉𝙊/𝘼⦔〙──\n╏ᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔıllıllı\n╏ *_ @user ingresaste a_* \n╏ *_@subject _*\n╏\n╏ᚒ⌬ *_Habla mano, go Left?_*\n╏ᚒ⌬ *_Grupo de joda y tambien de Left pe_* \n╏ᚒ⌬ *_¿Quieres ver que hago? 😗_* \n╏ᚒ⌬ *_Escribe: #menu_* \n╏ᚒ⌬ *_Papi, antes de todo, lee la descripción_*\n╏ ⬇️⬇️⬇️⬇️\n\n@desc\n\n╏\n╏ *_DISFRITA PAPI 👹️_*\n╏ *_PURO 🅱️🅰️🅱️🅾️🆘 AQUÍ_* \n┗ᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔꪶ࿋྄ིᤢꫂ'
  conn.bye = '┏ᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔ𝖲𝖠𝖮𝖮҉\n╏────〘 ༻𝘼𝙇𝘼𝙊𝙕 𝙈𝘼𝙉𝙊༺ 〙────\n╏ᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔ𝖲𝖠𝖮𝖮҉\n╏ *_🥺 Se fue mi culito pipipi @user_* 😥\n╏UN 🅱️🅰️🅱️🅾️️️️S⃞    O⃞    MENOS 😙\n ┗ᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔᚔ𝖲𝖠𝖮𝖮҉'
  conn.spromote = '*@user 𝙴𝚂 𝙴𝙻 𝙽𝚄𝙴𝚅𝙾 𝙲𝙷𝙾𝙻𝙾 𝙿𝙾𝚆𝙴𝚁 !!*'
  conn.sdemote = '*@user 𝙳𝙴𝙹𝙾́ 𝙳𝙴 𝚂𝙴𝚁 𝙲𝙷𝙾𝙻𝙾 𝙿𝙾𝚆𝙴𝚁 !!*'
